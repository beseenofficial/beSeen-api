...
const KEY_DERIVATION_SALT = 'beseen.fi/key-derivation/v1';
const KEY_DERIVATION_TRANSACTION_OPERATION = 'manageData';
const KEY_DERIVATION_TRANSACTION_DATA_NAME = 'beseen_kdf_v1';
const KEY_DERIVATION_SIGNING_INFO = 'beseen.fi/ed25519-signing-key/v1';
const KEY_DERIVATION_INPUT = 'RAW-64-BYTE-STELLAR-TRANSACTION-SIGNATURE';
const KEY_DERIVATION_TRANSACTION_DATA_VALUE = 'beseen.fi/key-derivation/v1';
const KEY_DERIVATION_ENCRYPTION_INFO = 'beseen.fi/x25519-encryption-key/v1';
